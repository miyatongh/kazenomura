...
全30枚のプレゼンテーションを python-pptx で作成
"""
...
def add_page_number(slide, num, total=30, color=C_GRAY):
    """右下にページ番号を追加"""
